...
export async function generateGame(
  ...
  if (!skipAssets) {
    ...
    console.log(chalk.dim('   ⏭ Skipping asset generation (--no-assets)'));
  }
  ...
  for (const file of files) {
    ...
    console.log(chalk.green(`   ✓ Created ${slug}/${file}`));
  }
  ...
  if (!configContent) {
    ...
    console.log(chalk.magenta('   ✨ Config generated by AI'));
  }
  ...
  console.log(chalk.green(`   ✓ Created ${slug}/src/config.js`));
  ...
  if (await fse.pathExists(readmeTmplPath)) {
    ...
    console.log(chalk.green(`   ✓ Created ${slug}/README.md`));
  }
  ...
  console.log(chalk.green(`   ✓ Created ${slug}/game-snapshot.json`));
